        ...
        <div className="w-full lg:w-[45rem] max-md:w-[30rem] md:w-[40rem] sm:w-[35rem] md:bg-Neutral-grayishWhite rounded-lg">
          <div className="grid md:grid-cols-3 md:gap-5 p-[1rem]">
            ...
            <div className="px-8 rounded md:col-span-2 max-md:bg-Neutral-grayishWhite max-md:mx-[4rem] relative max-md:bottom-[8rem] max-md:rounded-lg">
              <h1 className="text-[1.8rem] text-Primary-veryDarkGray font-bold mt-4 ">Primary Contact</h1>
              ...
              <div className="flex justify-between mb-10 mt-7">
                <button className="px-5 py-2 mt-20 font-bold rounded-lg text-Neutral-darkGray" onClick={handleBack}>
                  Go Back
                </button>
                <button className="px-5 py-2 mt-20 font-bold rounded-lg bg-Primary-veryDarkGray text-Neutral-veryLightGray" onClick={handleSubmit}>
                  Next Step
                </button>
              </div>
            </div>
