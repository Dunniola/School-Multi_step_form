      ...
      <div className="w-full lg:w-[45rem] max-md:w-[30rem] md:w-[40rem] sm:w-[35rem] md:bg-Neutral-grayishWhite rounded-lg">
        <div className="grid md:grid-cols-3 md:gap-5 p-[1rem]">
          ...
          <div className="px-8 rounded md:col-span-2 max-md:bg-Neutral-grayishWhite max-md:mx-[4rem] relative max-md:bottom-[8rem] max-md:rounded-lg">
            <h1 className="text-[1.8rem] text-Primary-veryDarkGray font-bold mt-4">School Information</h1>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="relative  md:hidden h-[8rem]">
                <button
                  type="submit"
                  className="absolute right-0 px-5 py-2 font-bold transform rounded md:bottom-0 bg-Primary-veryDarkGray text-Neutral-veryLightGray max-md:bottom-5"
                >
                  Next Step
                </button>
              </div>
