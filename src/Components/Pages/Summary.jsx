...
import imageBg from "/src/assets/Images/Desktop/desktop.jpg";
      ...
      <div className="w-full lg:w-[45rem] max-md:w-[30rem] md:w-[40rem] sm:w-[35rem] md:bg-Neutral-grayishWhite rounded-lg">
        <div className="grid md:grid-cols-3 md:gap-5 p-[1rem]">
          ...
          <div className="px-8 rounded md:col-span-2 max-md:bg-Neutral-grayishWhite max-md:mx-[4rem] relative max-md:bottom-[8rem] max-md:rounded-lg">
            <h1 className="text-[1.8rem] text-Primary-veryDarkGray font-bold mt-4">Summary</h1>
            ...
            <div className="p-3 leading-3 rounded bg-Neutral-veryVeryLightGray">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex justify-start">
                  <span className="font-semibold w-[12rem]">School Name: </span>
                  {formData.stepOne?.name || ""}
                </div>
                <div className="flex leading-5">
                  <span className="font-semibold w-[12rem]">School Address: </span>
                  <div className="flex-1 text-start">
                  {formData.stepOne?.address || ""}
                </div>
                </div>
                <div className="flex justify-start">
                  <span className="font-semibold w-[12rem]">No of Employees: </span>
              ...
              <div className="flex flex-col gap-2">
                <div className="flex justify-start">
                  <span className="font-semibold w-[12rem]">Email: </span>
                  {formData.stepTwo?.email || ""}
                </div>
                <div className="flex justify-start">
                  <span className="font-semibold w-[12rem]">Phone Number: </span>
              ...
              <div className="flex flex-col gap-2">
                <div className="flex justify-start">
                  <span className="font-semibold w-[12rem]">Contact Name: </span>
                  {formData.stepThree?.contact_name || ""}
                </div>
                <div className="flex justify-start">
                  <span className="font-semibold w-[12rem]">Contact Email: </span>
                  {formData.stepThree?.contact_email || ""}
                </div>
                <div className="flex justify-start">
                  <span className="font-semibold w-[12rem]">Contact Phone Number: </span>
              ...
              <div className="flex justify-start">
                <span className="font-semibold w-[12rem]">School Code: </span>
            ...
            <div className="flex justify-between mt-10 mb-5">
              <button
                className="px-5 py-2 font-bold rounded-lg text-Neutral-darkGray"
                onClick={handleBack}
              >
                Go Back
              </button>
              <button
                className="px-5 py-2 font-bold rounded-lg bg-Primary-veryDarkGray text-Neutral-veryLightGray"
