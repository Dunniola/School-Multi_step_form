      ...
      <div className="w-full lg:w-[45rem] max-md:w-[30rem] md:w-[40rem] sm:w-[35rem] md:bg-Neutral-grayishWhite rounded-lg">
        <div className="grid md:grid-cols-3 md:gap-5 p-[1rem]">
          ...
          <div className="px-8 rounded md:col-span-2 max-md:bg-Neutral-grayishWhite max-md:mx-[4rem] relative max-md:bottom-[8rem] max-md:rounded-lg">
            <h1 className="text-[1.8rem] text-Primary-veryDarkGray font-bold mt-4 ">Contact Information</h1>
            ...
            <div className="flex justify-between mb-[2rem] mt-[7rem]">
              <div>
                <button className="px-5 py-2 font-bold rounded-lg text-Neutral-darkGray max-md:bottom-5" onClick={handleBack}> 
                  Go Back
                </button>
              </div>
              <div>
                <button className="px-5 py-2 font-bold rounded py- bg-Primary-veryDarkGray text-Neutral-veryLightGray" onClick={handleSubmit}>
                  Next Step
                </button>
              </div>
            </div>
...
const InputField = ({ name, value, placeholder, id, label, onChange, error, type, disabled }) => {
  return (
    <div className="mt-3 font-semibold text-Primary-veryDarkGray">
